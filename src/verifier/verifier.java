...
public class verifier {
    ...
    public static Expression generateVerification(Function fun){
        ...
        Expression awp = awp(fun.start, null);
        System.out.println(awp);
        System.out.println();

        System.out.println("Now computing: verification conditions: ");
        Expression vc = VC(fun.start, new True());
        System.out.println(vc);
        System.out.println();

        System.out.println("Now verifying the conditions:");
        System.out.println(vc + "\t&&\t" + fun.precond + " => " + awp + "?\n\n");
        
        return new And(vc, new Or(new Not(fun.precond), awp));
    }
